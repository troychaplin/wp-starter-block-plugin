...
class FAQs
{
  ...
  {
    add_action('rest_api_init', [$this, 'register_custom_faq_endpoint']);
  }

  public function register_custom_faq_endpoint()
  {
    register_rest_route('idc/v1', '/faqs', array(
      'methods' => 'GET',
      'callback' => [$this, 'custom_faq_endpoint'],
      'permission_callback' => '__return_true',
    ));
  }

  public function custom_faq_endpoint($request)
  {
